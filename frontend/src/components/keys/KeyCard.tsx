...
export const KeyCard: React.FC<KeyCardProps> = ({
 ...
 default:
 return 'bg-white/[0.05] text-foreground border border-border';
 }
 };
 ...
 return (
 <Card className="group hover:bg-white/[0.04] transition-colors duration-200">
 ...
 <CardTitle className="text-base font-w590 truncate">
 {sshKey.key_name || 'Unnamed Key'}
 </CardTitle>
 <div className="flex items-center text-xs text-muted-foreground mt-1 space-x-2">
 <span className={cn("px-1.5 py-0.5 rounded text-[10px] font-w510 uppercase", getKeyTypeColor(sshKey.key_type))}>
 ...
 <div className="flex flex-col p-3 rounded-md bg-white/[0.02] border border-border">
 <div className="flex items-center space-x-2 mb-1">
 <User size={14} className="text-muted-foreground" />
 <span className="text-xs font-w510 text-muted-foreground">Assigned To</span>
 </div>
 <span className={cn("text-sm font-w590 truncate", !isAssigned && "text-muted-foreground italic")}>
 ...
 <span className="text-xs font-w510 text-muted-foreground">Access</span>
 </div>
 <span className="text-sm font-w590">
 ...
 <p className="text-xs text-muted-foreground mb-4 line-clamp-2 min-h-[2.5em] bg-white/[0.02] p-2 rounded-md border border-border">
 {sshKey.extra_comment}
 </p>
 )}
