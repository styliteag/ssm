...
export const AddAuthorizationModal: React.FC<AddAuthorizationModalProps> = ({
 ...
 {authorizationExists && (
 <div className="flex items-start space-x-3 p-4 bg-warning/10 dark:bg-warning/20 border border-warning/30 dark:border-warning/30 rounded-lg">
 <AlertTriangle className="h-5 w-5 text-warning flex-shrink-0 mt-0.5" />
 <div>
 <h4 className="text-sm font-w510 text-warning ">
...
export const BulkGrantModal: React.FC<BulkGrantModalProps> = ({
 ...
 selectedUsers.has(user.id) && 'bg-primary/10 dark:bg-primary/30 border border-primary/30 dark:border-primary/30'
 )}
 ...
 ? 'bg-primary border-primary/30 dark:bg-primary dark:border-primary/30'
 ...
 className={cn(
 'flex items-center space-x-2 p-2 rounded cursor-pointer hover:bg-muted/50 transition-colors',
 selectedHosts.has(host.id) && 'bg-primary/10 dark:bg-primary/30 border border-primary/30 dark:border-primary/30'
 )}
 ...
 <div className="text-sm font-w510 text-foreground">{host.name}</div>
 ...
 <Card variant="elevated" className="bg-primary/10 dark:bg-primary/30 border-primary/30 dark:border-primary/30">
 <CardContent className="p-4">
 <div className="flex items-start space-x-3">
 <Info className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
 <div>
 <h4 className="text-sm font-w510 text-primary ">
 Operation Summary
 </h4>
 <div className="text-sm text-primary dark:text-primary mt-1 space-y-1">
...
export const DeleteAuthorizationModal: React.FC<DeleteAuthorizationModalProps> = ({
 ...
 <span className="font-w510">{user?.username || 'this user'}</span> to{' '}
 <span className="font-w510">{host?.name || 'this host'}</span>?
 </p>
 {authorization?.login && (
 ...
 <p className="text-sm text-destructive mt-2 font-w510">
