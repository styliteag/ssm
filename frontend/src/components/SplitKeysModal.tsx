...
const SplitKeysModal: React.FC<SplitKeysModalProps> = ({
 ...
 <UserPlus className="text-primary dark:text-primary mt-1" size={20} />
 <div>
 <h3 className="text-lg font-w510 text-primary ">
 Split User Keys
 </h3>
 ...
 <div>
 <label htmlFor="newUsername" className="block text-sm font-w510 text-foreground/80 mb-1">
 New Username
 </label>
 <Input
 id="newUsername"
 ...
 <div className="bg-destructive/10 dark:bg-destructive/20 p-3 rounded-md mb-4">
 <div className="flex items-start space-x-2">
 <AlertTriangle className="text-destructive dark:text-destructive mt-1" size={16} />
 <div className="text-sm text-destructive ">
 <p className="font-w510">Validation Error</p>
 ...
 <span className="bg-primary/10 dark:bg-primary/30 text-primary dark:text-primary text-xs font-w510 px-2 py-1 rounded">
 {key.key_type}
 </span>
 {key.key_name && (
 ...
 <code className="bg-primary/10 dark:bg-primary/30 text-primary dark:text-primary px-2 py-1 rounded font-w510">
 {auth.login}
 </code>
 </div>
 {auth.options && (
