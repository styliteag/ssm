...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen lg:flex">
      ...
      {/* Sidebar */}
      <div className={`
        fixed inset-y-0 left-0 z-50 w-64 bg-card shadow-lg transform transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 lg:flex-shrink-0
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Button
                ...
                className="w-full justify-start text-muted-foreground hover:text-destructive px-4 py-2 text-sm font-medium rounded-md transition-colors cursor-pointer"
      ...
      <div className="flex flex-col min-h-screen lg:flex-1">
        {/* Top bar */}
        <header className="flex-shrink-0 h-16 bg-card shadow-sm border-b border-border lg:hidden">
