...
const AuthorizationMatrix: React.FC<AuthorizationMatrixProps> = ({
 ...
 if (count > 0) {
 return <span className="text-sm font-w590 text-success dark:text-success">{count}</span>;
 }
 ...
 'bg-success/10 dark:bg-success/20': (cell.isAuthorized || (isAllMode && hasAuthorizations)) && !cell.loading,
 'hover:bg-success/10 dark:hover:bg-success/30': cell.isAuthorized && !cell.loading && !isAllMode,
 ...
 // Hover states
 'ring-2 ring-primary/50 ring-opacity-50': isHovered && !isAllMode,
 ...
 <div className="w-40 h-16 flex items-center px-3 border-r border-border font-w510 text-sm text-foreground">
 Users / Hosts
 </div>
 {filteredHosts.map((host) => (
 <div
 key={host.id}
 className="w-12 h-16 flex items-center justify-center border-r border-border cursor-pointer hover:bg-primary/10 dark:hover:bg-primary/20 transition-colors relative overflow-hidden"
 title={`${host.name} (${host.address}) - Click to navigate to hosts page`}
 onClick={() => handleHostClick(host.name)}
 >
 <span className="text-xs font-w510 transform -rotate-45 origin-center whitespace-nowrap text-foreground absolute hover:text-primary dark:hover:text-primary transition-colors">
 ...
 <div
 className={cn(
 'w-40 h-8 flex items-center px-3 border-r border-b border-border text-sm cursor-pointer hover:bg-primary/10 dark:hover:bg-primary/20 transition-colors',
 ...
 >
 <span className="truncate text-foreground hover:text-primary dark:hover:text-primary transition-colors">
 ...
 <>
 <div className="flex items-center space-x-2">
 <div className="w-6 h-6 bg-success/10 dark:bg-success/20 border border-success/30 dark:border-success/30 rounded flex items-center justify-center">
 <span className="text-xs font-w590 text-success dark:text-success">N</span>
 </div>
 ...
 <>
 <div className="flex items-center space-x-2">
 <div className="w-4 h-4 bg-success/10 dark:bg-success/20 border border-success/30 dark:border-success/30 rounded flex items-center justify-center">
 ...
 <div className="flex items-center space-x-2">
 <div className="w-4 h-4 bg-primary/10 border border-primary/30 dark:border-primary/30 rounded flex items-center justify-center">
