...
const MergeUsersModal: React.FC<MergeUsersModalProps> = ({
 ...
 <p className="font-w510 text-foreground truncate">{user.username}</p>
 ...
 <label className="block text-xs font-w510 text-muted-foreground">Destination User</label>
 <select
 value={targetUserId ?? ''}
 ...
 <div>
 <label htmlFor="merge-new-username" className="block text-xs font-w510 text-muted-foreground">New Username</label>
 <Input
 ...
 <div>
 <label className="block text-xs font-w510 text-muted-foreground mb-1">Account Status</label>
 <select
 ...
 <div>
 <label htmlFor="merge-new-comment" className="block text-xs font-w510 text-muted-foreground">Comment</label>
 <textarea
 ...
 <p className="font-w510">Merge Users</p>
 <p>
