...
const SyncAllModal: React.FC<SyncAllModalProps> = ({
 ...
 <h3 className="text-success font-w510">
 Sync Completed
 </h3>
 ...
 <div className="flex-1">
 <h3 className="text-destructive font-w510">Sync Error</h3>
 ...
 <div>
 <h3 className="text-primary font-w510">
 ...
 <h4 className="text-lg font-w590 text-foreground mb-4">
 Hosts to Sync
 </h4>
 ...
 <div className="flex-1">
 <div className="font-w510 text-foreground">
 {host.name}
 </div>
 ...
 <div className="text-sm font-w510 text-foreground/80">
 ...
 <h4 className="text-lg font-w590 text-foreground">
 ...
 <div className="text-sm text-muted-foreground">
 <span className="text-success dark:text-success font-w510">{successCount} succeeded</span>
 {errorCount > 0 && (
 <>
 {' • '}
 <span className="text-destructive font-w510">{errorCount} failed</span>
 </>
 )}
 </div>
 </div>
