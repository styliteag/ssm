...
function DataTable<T extends Record<string, unknown>>({
 ...
 <label className="text-sm font-w510 text-muted-foreground">
 Show:
 </label>
 <select
 value={itemsPerPage}
 ...
 className="h-8 px-2 py-1 text-sm border border-border rounded-md bg-white/[0.02] text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-ring"
 >
 ...
 sortable && column.sortable !== false && column.key !== 'actions' && 'cursor-pointer hover:bg-white/[0.03] transition-colors',
 ...
 selectable && isItemSelected(item) && 'bg-primary/15',
