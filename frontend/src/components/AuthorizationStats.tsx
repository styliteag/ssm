...
const AuthorizationStats: React.FC<AuthorizationStatsProps> = ({
 ...
 <div>
 <p className="text-sm font-w510 text-muted-foreground">
 {stat.label}
 </p>
 <div className="flex items-baseline space-x-2">
 <p className={cn('text-2xl font-w590', stat.color)}>
 ...
 <div className={cn(
 'flex items-center justify-center w-8 h-8 rounded-full text-sm font-w510',
 index === 0 ? 'bg-warning/10 text-warning dark:bg-warning ' :
 index === 1 ? 'bg-muted text-foreground' :
 index === 2 ? 'bg-warning/10 text-warning dark:bg-warning ' :
 'bg-primary/10 text-primary dark:bg-primary '
 )}>
 {index + 1}
 </div>
 <div>
 ...
 className="font-w510 text-left hover:text-primary dark:hover:text-primary transition-colors underline-offset-2 hover:underline text-foreground"
 >
 {item.host.name}
 </button>
 ...
 className="h-10 w-10 p-1 text-muted-foreground hover:text-primary hover:bg-primary/10 dark:hover:bg-primary/20"
 title="Edit host"
 >
 <Edit2 size={20} />
 </Button>
 <div className="text-right">
 <div className="font-w590 text-foreground">
 ...
 item.user.enabled ? 'bg-success' : 'bg-destructive'
 )} />
 <button
 onClick={() => handleUserClick(item.user.username)}
 className={cn(
 'font-w510 text-left hover:text-primary dark:hover:text-primary transition-colors underline-offset-2 hover:underline text-foreground',
