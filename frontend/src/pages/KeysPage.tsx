...
const KeysPage: React.FC = () => {
 ...
 switch (keyType) {
 case 'ssh-rsa':
 return 'bg-primary/10 text-primary dark:bg-primary ';
 case 'ssh-ed25519':
 return 'bg-success/10 text-success dark:bg-success ';
 case 'ecdsa-sha2-nistp256':
 case 'ecdsa-sha2-nistp384':
 case 'ecdsa-sha2-nistp521':
 return 'bg-accent/10 text-accent dark:bg-accent ';
 default:
 ...
 <span className={item.user_id && item.user_id !== 0 ? 'text-foreground' : 'text-muted-foreground'}>
 ...
 <span className="font-w510">Name:</span> {(value as string) || '—'}
 </div>
 {key.extra_comment && (
 <div className="truncate text-xs mt-1">
 <span className="font-w510">Comment:</span> {key.extra_comment}
 </div>
 )}
 </div>
 ),
 ...
 <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-w510 ${getKeyTypeBadgeColor(item.key_type)}`}>
 ...
 <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 rounded-2xl bg-card/30 backdrop-blur-xl border border-border/50 ">
 <div>
 ...
 className=" shadow-primary/20 h-10"
 >
 ...
 <div className="p-4 rounded-xl bg-gradient-to-br from-blue-500/10 to-blue-600/5 border border-primary/30/20">
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm text-muted-foreground">Total Keys</p>
 <p className="text-2xl font-w590 text-foreground">{keys.length}</p>
 </div>
 <Key size={24} className="text-primary" />
 </div>
 </div>

 <div className="p-4 rounded-xl bg-gradient-to-br from-green-500/10 to-green-600/5 border border-success/30/20">
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm text-muted-foreground">Assigned</p>
 <p className="text-2xl font-w590 text-foreground">{keys.filter(k => k.user_id && k.user_id !== 0).length}</p>
 </div>
 <UserCheck size={24} className="text-success" />
 </div>
 </div>

 <div className="p-4 rounded-xl bg-gradient-to-br from-purple-500/10 to-purple-600/5 border border-accent/30/20">
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm text-muted-foreground">Active Users</p>
 <p className="text-2xl font-w590 text-foreground">{users.filter(u => u.enabled).length}</p>
 </div>
 <Users size={24} className="text-accent" />
 </div>
 </div>

 <div className="p-4 rounded-xl bg-gradient-to-br from-yellow-500/10 to-yellow-600/5 border border-warning/30/20">
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm text-muted-foreground">Unassigned</p>
 <p className="text-2xl font-w590 text-foreground">{unassignedKeys.length}</p>
 </div>
 ...
 <Card className="border-border/50 bg-card/50 backdrop-blur-sm overflow-hidden shadow-linear-dialog">
 ...
 <div>
 <h3 className="font-w510 text-foreground">
 ...
 <span className="text-sm font-w510 text-muted-foreground">Key Type:</span>
 <span className="text-sm text-foreground">{selectedKey.key_type.replace('ssh-', '').toUpperCase()}</span>
 </div>
 <div className="flex justify-between">
 <span className="text-sm font-w510 text-muted-foreground">User:</span>
 <span className="text-sm text-foreground">{selectedKey.username || 'Unassigned'}</span>
 </div>
 <div className="flex justify-between">
 <span className="text-sm font-w510 text-muted-foreground">Key Name:</span>
 <span className="text-sm text-foreground">{selectedKey.key_name || '—'}</span>
 </div>
 {selectedKey.extra_comment && (
 <div className="flex justify-between">
 <span className="text-sm font-w510 text-muted-foreground">Extra Comment:</span>
 <span className="text-sm text-foreground">{selectedKey.extra_comment}</span>
 </div>
 )}
 <div className="flex justify-between">
 <span className="text-sm font-w510 text-muted-foreground">Host Access:</span>
 ...
 {/* Key Information */}
 <div className="space-y-4">
 <h3 className="text-lg font-w510 text-foreground">Key Information</h3>
 <div className="grid grid-cols-2 gap-4">
 <div>
 <label className="text-sm font-w510 text-muted-foreground">Key Type</label>
 <p className="mt-1 text-foreground">{selectedKey.key_type}</p>
 </div>
 <div>
 <label className="text-sm font-w510 text-muted-foreground">Status</label>
 ...
 <div>
 <label className="text-sm font-w510 text-muted-foreground">Assigned User</label>
 <p className="mt-1 text-foreground">{selectedKey.username || 'Unassigned'}</p>
 </div>
 <div>
 <label className="text-sm font-w510 text-muted-foreground">Host Access</label>
 ...
 <div>
 <div className="flex items-center justify-between">
 <label className="text-sm font-w510 text-muted-foreground">Key Name</label>
 <Button
 variant="ghost"
 size="sm"
 onClick={() => {
 ...
 <div>
 <div className="flex items-center justify-between">
 <label className="text-sm font-w510 text-muted-foreground">Extra Comment</label>
 <Button
 variant="ghost"
 size="sm"
 onClick={() => {
 ...
 <div className="space-y-2">
 <div className="flex items-center justify-between">
 <label className="text-sm font-w510 text-muted-foreground">Full SSH Key</label>
 <Button
 variant="ghost"
 size="sm"
 ...
 <div className="space-y-4">
 <h3 className="text-lg font-w510 text-foreground">Access Details</h3>
 <div className="bg-muted/50 rounded-lg p-4">
 ...
 <div className="space-y-4">
 <div className="bg-primary/10 dark:bg-primary/20 rounded-lg p-4">
 <h4 className="font-w510 text-primary ">Import Instructions</h4>
 <ul className="mt-2 text-sm text-primary dark:text-primary list-disc list-inside space-y-1">
