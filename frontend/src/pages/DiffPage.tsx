...
const DiffPage: React.FC = () => {
 ...
 position="top"
 >
 <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-w510 bg-muted text-muted-foreground cursor-help">
 ...
 <div className="font-w590">Connection Error</div>
 <div className="text-xs">{host.error}</div>
 </div>
 }
 position="top"
 >
 <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-w510 bg-destructive/10 dark:bg-destructive/30 text-destructive dark:text-destructive cursor-help">
 Error
 </span>
 </Tooltip>
 );
 ...
 content={
 <div className="space-y-1">
 <div className="font-w590">Keys Out of Sync</div>
 ...
 position="top"
 >
 <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-w510 bg-success/10 dark:bg-success/30 text-success dark:text-success cursor-help">
 Synchronized
 </span>
 </Tooltip>
 );
 ...
 return (
 <span className={host.total_items > 0 ? 'text-destructive dark:text-destructive font-w510' : 'text-muted-foreground'}>
 ...
 className="whitespace-nowrap bg-primary hover:bg-primary"
 ...
 leftIcon={<Upload size={16} />}
 variant="primary"
 className="bg-primary hover:bg-primary font-w510 px-4 py-2"
 size="sm"
 >
 Sync Keys
 </Button>
 ...
 <div className="bg-destructive/10 dark:bg-destructive/20 border border-destructive/30 dark:border-destructive/30 rounded-lg p-4">
 ...
 <div>
 <h4 className="text-destructive font-w510">Failed to load host details</h4>
 ...
 <h3 className="text-lg font-w590 text-foreground mb-3 border-b border-border pb-2">Host Information</h3>
 <div className="grid grid-cols-2 gap-x-6 gap-y-3">
 <div className="flex flex-col">
 <span className="text-xs font-w510 text-muted-foreground uppercase tracking-wide">ID</span>
 <span className="text-sm font-w590 text-foreground mt-1">{hostDetails.host.id}</span>
 </div>
 <div className="flex flex-col">
 <span className="text-xs font-w510 text-muted-foreground uppercase tracking-wide">Name</span>
 <span className="text-sm font-w590 text-foreground mt-1">{hostDetails.host.name}</span>
 </div>
 <div className="flex flex-col">
 <span className="text-xs font-w510 text-muted-foreground uppercase tracking-wide">Address</span>
 <span className="text-sm font-w590 text-foreground mt-1">{hostDetails.host.address}</span>
 </div>
 <div className="flex flex-col">
 <span className="text-xs font-w510 text-muted-foreground uppercase tracking-wide">Last Updated</span>
 <span className="text-sm font-w590 text-foreground mt-1">
 ...
 {/* Status Summary */}
 <div className="bg-card rounded-lg border border-border p-4">
 <h3 className="text-lg font-w590 text-foreground mb-3 border-b border-border pb-2">Status Summary</h3>
 <div className="flex items-center justify-between mb-3">
 <span className={`inline-flex items-center px-3 py-1.5 rounded-full text-sm font-w590 ${hostDetails.logins.length === 0
 ? 'bg-success/10 dark:bg-success/30 text-success dark:text-success border border-success/30 dark:border-success/30'
 : 'bg-destructive/10 dark:bg-destructive/30 text-destructive dark:text-destructive border border-destructive/30 dark:border-destructive/30'
 }`}>
 ...
 <div className="bg-card rounded-lg border border-border p-4">
 <h3 className="text-lg font-w590 text-foreground mb-3 border-b border-border pb-2">Expected Keys</h3>
 ...
 <span className="font-w590 text-foreground text-sm">{key.username}</span>
 ...
 <span className="text-xs bg-primary/10 dark:bg-primary/50 text-primary px-2 py-1 rounded-full ml-2 flex-shrink-0 font-w510">
 {key.key_type}
 </span>
 </div>
 {key.options && (
 ...
 <div className="bg-card rounded-lg border border-border p-4">
 <h3 className="text-lg font-w590 text-foreground mb-3 border-b border-border pb-2">Issues Found</h3>
 ...
 <div className="flex items-center justify-between">
 <h4 className="text-sm font-w590 text-foreground flex items-center">
 <span className="text-muted-foreground mr-2">Login:</span>
 <code className="bg-primary/10 dark:bg-primary/50 text-primary px-2 py-1 rounded-md text-xs font-w590">{loginDiff.login}</code>
 </h4>
 <span className="text-xs text-muted-foreground bg-card px-2 py-1 rounded-full font-w510">
 ...
 <div className="bg-muted/50 border border-border rounded-lg p-2 hover: transition-shadow">
 ...
 <span className="font-w510">Ready to apply changes?</span>
 </div>
 ...
 variant="primary"
 leftIcon={<Upload size={16} />}
 className="bg-primary hover:bg-primary font-w510 px-6"
 >
 Sync Keys
 </Button>
 )}
 ...
 <h4 className="font-w510 text-foreground mb-2">Key Details</h4>
 ...
 <h4 className="font-w510 text-foreground">Choose an option:</h4>

 {/* Assign to existing user */}
 <div className="space-y-2">
 <label className="block text-sm font-w510 text-foreground/80">
 Assign to existing user:
 </label>
 <select
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm font-w510 text-foreground/80">
 Create new user
 </p>
 {unknownKeyIssue.details?.key?.comment ? (
 <div className="space-y-1">
 ...
 if (existingUser) {
 return <p className="text-xs text-warning">User already exists</p>;
 } else if (!isValid) {
 return <p className="text-xs text-destructive">Invalid username format</p>;
 }
 return null;
 })()}
 </div>
