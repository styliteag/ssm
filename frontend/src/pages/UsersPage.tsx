...
const UsersPage: React.FC = () => {
 ...
 const colors = {
 enabled: 'text-success bg-success/10 dark:text-success dark:bg-success/20',
 disabled: 'text-destructive bg-destructive/10 dark:text-destructive dark:bg-destructive/20'
 };
 const icons = {
 ...
 return (
 <div className={`inline-flex items-center space-x-1 px-2 py-1 rounded-full text-xs font-w510 ${colors[status]}`}>
 {icons[status]}
 ...
 <span className="text-sm font-w510">
 {(count as number) || 0}
 </span>
 {((count as number) || 0) > 0 && (
 <Button
 ...
 <Button onClick={() => setShowAddModal(true)} className=" shadow-primary/20 h-10">
 ...
 <div className="bg-warning/10 dark:bg-warning/20 p-3 rounded-md">
 <div className="flex items-start space-x-2">
 <AlertCircle className="text-warning dark:text-warning mt-1" size={16} />
 <div className="text-sm text-warning ">
 <p className="font-w510">Impact of deletion:</p>
 ...
 <h3 className="mt-4 text-lg font-w510 text-foreground">
 No SSH Keys
 </h3>
 ...
 <span className="bg-primary/10 text-primary text-xs font-w510 px-2 py-1 rounded">
 {key.key_type}
 </span>
 {key.key_name && (
 ...
 <div className="font-w510 text-foreground text-sm truncate">
 ...
 <span className="font-w510 text-muted-foreground">Login as:</span>
 <code className="bg-primary/10 text-primary px-2 py-1 rounded font-w510">{auth.login}</code>
 </div>
 {auth.options && (
 <div className="flex items-start space-x-1">
 <span className="font-w510 text-muted-foreground mt-0.5">Options:</span>
