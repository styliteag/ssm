defmodule SsmWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: SsmWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SsmWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SsmWeb.Gettext, "errors", msg, opts)
    end
  end
