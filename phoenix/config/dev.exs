...
config :ssm, Ssm.Repo,
  database: Path.expand("../ssm_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :ssm, SsmWeb.Endpoint,
  ...
  secret_key_base: "ssm-dev-only-secret-key-base-0000000000-1111111111-2222222222-3333333333",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:ssm, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:ssm, ~w(--watch)]}
  ]
